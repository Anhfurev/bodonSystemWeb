...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-90 ${isFixed ? "fixed top-0 left-0 w-full h-screen overflow-hidden" : "w-full h-full"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        <aside
          ...
          aria-hidden={!open}
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5 justify-between">
            <ul
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div
                className="sm-socials  pt-8 flex flex-col gap-3"
