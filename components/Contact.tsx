...
export function Contact({ isMenuOpen }: { isMenuOpen: boolean }) {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="flex justify-center snap-start items-start sm:items-center h-fit sm:h-screen px-3 sm:px-4 md:px-6 transition-all duration-500 pt-2 sm:pt-0 pb-4 sm:pb-0"
    >
      <motion.div
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            >
              ...
              >
                <div className="lg:max-w-5xl max-w-4xl m-auto justify-center items-center">
                  <motion.div
